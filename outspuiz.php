<?php
//check GET variable content exist before accessing it.
...
<html>
        ...
        $(document).ready(function () {
          ...
          function usersList(users) {
            ...
            for (var a = 0; a < users.length; a++) {
              ...
              delete_user.className = 'use_delete tooltip far fa-trash-alt';
              delete_user.style.color = '#d50000';
              delete_user.style.display = 'inline-block';
              delete_user.style.cursor = 'pointer';
              delete_user.style.title = 'Delete user';
              delete_user.setAttribute('user_id', users[a].id);
              var delete_tooltip = document.createElement('span');
              delete_tooltip.innerHTML = 'Delete user';
              delete_tooltip.className = 'tooltiptext';
              delete_user.appendChild(delete_tooltip);
          ...
          $('#toggle_add_user_form').click(function () {
            if ($('#cruds_cont').is(':visible')) {
              $('#cruds_cont').hide();
              $(this).html('Show Add User form');
            } else {
              $('#cruds_cont').show();
              $(this).html('Hide Add User form');
            }
          });
  ...
  <body>
    ...
    <div id="main_cont">
      ...
      <button class='toggle_add_user_form'id='toggle_add_user_form'>Show Add User form</button>
      <div id="cruds_cont" style="display: none;">
        ...
        <form action='cruds.php' id='add_user_form'>
          ...
          <div class='input_cont'>
            ...
            <input class='age' type='number' min="0" name='age' id='age'/>
          </div>
          <div class='input_cont'>
